# coding=utf-8
"""Dialogs for importing external tool data into a fresh tool database
(mill flavor) -- starting points for transitioning to the DB-backed tool
table, not live merges into the running one.

The mill counterpart of probe_basic_lathe.import_tbl_dialog. Same dialog
skeleton and safety model; only the importer each dialog drives (and its
guidance text) differ:
